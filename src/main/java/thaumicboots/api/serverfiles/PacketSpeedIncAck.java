...
public class PacketSpeedIncAck implements IMessage, IMessageHandler<PacketSpeedIncAck, IMessage> {
    ...
    public IMessage onMessage(PacketSpeedIncAck message, MessageContext ctx) {
